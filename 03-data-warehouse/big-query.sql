...
OPTIONS (
  format = 'CSV',
  uris = ['gs://kestra-zoomcamp-de-demo-2026/yellow_tripdata_2019-*.csv' , 'gs://kestra-zoomcamp-de-demo-2026/yellow_tripdata_2020-*.csv']
); 

-- Check yellow trip data
SELECT * FROM zoomcamp.external_yellow_tripdata limit 10;
